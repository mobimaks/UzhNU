...
public class TimetablesFragment extends Fragment implements OnChildClickListener, OnGroupClickListener {
    ...
    public  void openFolder(String id, String caption, String parentId, String parentTitle){
        ...
        //get Data from DB
        try {
            timetable = (Timetable)new TimetableRequest().execute(ITEMS_FROM_DB, id).get();
        } catch (InterruptedException e) {
            e.printStackTrace();
        } catch (ExecutionException e) {
            e.printStackTrace();
        }
        //if DB doesn't empty we creating three
        if(timetable != null){
    ...
    class TimetableRequest extends AsyncTask<String, Void, Object>{
        ...
        protected Object doInBackground(String... params) {
            ...
            switch (type){
                case ITEMS_FROM_DB:
                    return getTimetableFromDB(id);
                case ITEMS_FROM_INTERNET:
                    return getTimetableFromSite(id);
            }
            return null;
        }
